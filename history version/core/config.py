...
LLM_SERVER_URL = "http://localhost:1234"  # Ollama server (port 11434)
...
ENABLE_PARALLEL_PROCESSING = True   # ✅ True: Process multiple chunks simultaneously, False: Sequential
...
XTTS_MAX_TEXT_LENGTH = 400          # Maximum text length for XTTS (longer texts split)
